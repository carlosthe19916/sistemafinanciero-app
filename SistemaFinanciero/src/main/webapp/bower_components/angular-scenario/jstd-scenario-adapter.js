 ...
 * Now, when you call <code>browser().navigateTo('home.html')</code> in your scenario test, the browser will open /your-prefix/home.html.
 * That matches the proxy, so JSTD will proxy this request to http://localhost:8000/home.html.
 */
